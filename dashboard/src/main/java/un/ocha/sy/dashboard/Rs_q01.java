	...
	public Response returnBrandParts(
		...
		try {
			...
			PreparedStatement  q_stm = conn.prepareStatement(
							"SELECT `01_online_iao_delivered`.Longitude_WGS84,                   "+
							"       `01_online_iao_delivered`.Latitude_WGS84,                    "+
							"       `01_online_iao_delivered`.Community_PCODE,                   "+
							"       `01_online_iao_delivered`.Location,                          "+
							"       SUM(`01_online_iao_delivered`.`Total Operations`) total,           "+
							...
							"                                                  AND ?)"+
							"GROUP BY `01_online_iao_delivered`.Longitude_WGS84,                 "+
							"         `01_online_iao_delivered`.Latitude_WGS84,                  "+
							"         `01_online_iao_delivered`.Community_PCODE,                 "+
							"         `01_online_iao_delivered`.Location,                        "+
							"         `01_online_iao_delivered`.Convoy_Type                      "
