		...
		try {
			String[] Stet_list=
					   {"truncate appds.01_online_iao_delivered;                                                                           ",
						...
						"insert appds.01_online_iao_delivered select * from appbk.01_online_iao_delivered;                                 ",
						"insert appds.04__05online_ia_requests select * from appbk.04__05online_ia_requests;                               ",
						"insert appds.06_online_target_approved_reached select * from appbk.06_online_target_approved_reached;             ",
						"insert appds.07_online_mountainreach select * from appbk.07_online_mountainreach;                                 ",
						"insert appds.1_31qrycnvs_all select * from appbk.1_31qrycnvs_all;                                                 ",
						"insert appds.1_34QryCnvs_Locations select * from appbk.1_34qrycnvs_locations;                                     ",
						"insert appds.1_3QryCnvs_All select * from appbk.1_3qrycnvs_all;                                                   ",
						"insert appds.2_4_1_Online_QryCnvs_All_ByAccessStatus select * from appbk.2_4_1_online_qrycnvs_all_byaccessstatus; ",
						"insert appds.QryAccess_Total select * from appbk.qryaccess_total;                                                 ",
						"insert appds.ocha_dashboard_webtag select * from appbk.ocha_dashboard_webtag;                                     "}; 
