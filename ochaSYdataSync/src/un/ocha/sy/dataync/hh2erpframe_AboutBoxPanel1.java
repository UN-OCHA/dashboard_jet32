...
public class hh2erpframe_AboutBoxPanel1 extends JPanel {
    ...
    public hh2erpframe_AboutBoxPanel1() {
        try {
            jbInit();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jbInit() throws Exception {
        ...
        labelTitle.setText(     "Title     : UN OCHA Dashboard DataSync " );
        labelAuthor.setText(    "Author    : MT IS Consultancy" );
        labelCopyright.setText( "Email     : mhd.tamer@outlook.com" );
        labelCompany.setText(   "Version   : 0.9.02 Beta" );
